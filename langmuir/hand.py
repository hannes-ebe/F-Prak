...
class data_class():
    ...
    def get_etemps(self):
        ...
        self.Dphip1=regress1.intercept_stderr*regress2.intercept*(regress1.slope-regress2.slope)\
                    +regress2.intercept_stderr*regress1.intercept*(regress1.slope-regress2.slope)\
        ...
        self.Te3=(self.floating-self.phip1)*const.e/const.k/np.log(0.6*np.sqrt(2*np.pi*const.electron_mass/mass_ar))
        self.DTe3="nry"#const.e/const.k/np.log(0.6*np.sqrt(2*np.pi*const.electron_mass/mass_ar))
        #get density
        ...
        print("Temperatur im E sÃ¤ttigung",self.Te2, self.DTe2)
        print("Plasma Potential",self.phip1,self.Dphip1)
        print("Temperatur aus Differenz der Potentiale",self.Te3)
